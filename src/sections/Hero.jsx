          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="mt-8 text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I’m Kethmika Edirisinghe. A university undergraduate
            ...
            <div className="mt-8 flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <AnimatedBorderButton asChild>
                <a
                  href="CV/Kethmika_Edirisinghe_CV.pdf"
                  download
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="mt-6 flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                ...
                {
                  icon: FaLinkedin,
                  href: "https://www.linkedin.com/in/kethmika-edirisinghe-aa3337268",
                },
                {
                  icon: FaInstagram,
                  href: "https://www.instagram.com/kethmikaedirisinghe?igsh=MnNqcnVybDQ3NWw3",
                },
              ].map((social, idx) => (
                <a
                  key={idx}
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                ...
                <div className="absolute -bottom-4 -right-4 glass rounded-xl px-4 py-3 animate-float">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium">Ready for Works</span>
                  </div>
                </div>
